...
4. WhatsApp Web links open for each contact
5. User clicks Send → Contacts receive live location
Fake Call workflow: Press Fake Call → Incoming call simulation → Accept/Decline*
...
- [Chandhana k s]: [designing]
- [Krishna kripa k]: [documentation]
## License
